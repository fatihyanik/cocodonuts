  ...
  return (
    <section className='grid grid-cols-1 md:grid-cols-2 gap-2 w-full' id='home'>
      <div className='py-2 flex-1 flex flex-col items-start justify-center gap-6'>
        <div className='flex items-center gap-2 justify-center bg-pink-100 px-4 py-1 rounded-full'>
          <p className='text-base text-pink-400 font-semibold'>
            <a
              href='https://www.lieferando.de/en/menu/coco-donuts'
              target='_blank'
            >
              Bike Delivery
            </a>
      ...
      <div className='py-2 flex-1 flex items-center relative'>
        ...
        <div className='w-full h-full absolute top-0 left-0 flex items-center justify-center lg:px  py-4 gap-4 flex-wrap'>
          {heroData &&
            heroData.map((n) => (
              <div
                key={n.id}
              ...
              >
                <img
                  src={n.imageSrc}
                  className='w-20 lg:w-40 -mt-10 lg:-mt-10 '
                  alt='I1'
                />
